...
let handler = async (m, { conn, usedPrefix: _p, __dirname, args }) => {
  ...
  let arrayMenu = ['all', 'anime', 'maker', 'primbon', 'edukasi', 'news', 'nsfw', 'random', 'jadian', 'xp', 'quran', 'stiker', 'kerangajaib', 'quotes', 'admin', 'group', 'premium', 'internet', 'anonymous', 'nulis', 'downloader', 'tools', 'fun', 'database', 'vote', 'nsfw', 'audio', 'info', 'owner', 'nocategory']
  ...
  try {
      ...
      const sections = [
   {
    ...
    {title: `❤ ${pmenus} Jadian`, rowId: ".? jadian", description: "Only Member Groups"},
	{title: `🎭 ${pmenus} Anonymous Chats`, rowId: ".? anonymous", description: "Bicara dengan orang tidak dikenal"},
	{title: `✏️ ${pmenus} Edukasi`, rowId: ".? edukasi", description: "Belajar Dengan Bot"},
	...
	{title: `🖌 ${pmenus} Maker`, rowId: ".? maker", description: "Buat logo dengan bot"},
    {title: `🎧 ${pmenus} Audio`, rowId: ".? audio", description: "Ubah Audio dengan Filter"},
    {title: `🎲 ${pmenus} Random`, rowId: ".? random", description: "Random Fitur BOt"},
